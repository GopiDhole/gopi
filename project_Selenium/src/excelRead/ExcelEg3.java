...
public class ExcelEg3 {
	...
	public static void main(String[] args) throws EncryptedDocumentException, IOException {
		...
		Sheet mySheet = WorkbookFactory.create(myfile).getSheet("Data3");
		int totalNumOfRows = mySheet.getLastRowNum();//gives total row count
		int rowCount = totalNumOfRows;
		System.out.println("Total number of rows are "+rowCount);
		
		short totalNumberOfCells = mySheet.getRow(totalNumOfRows).getLastCellNum();
